...
if __name__ == '__main__':
    ...
    parser.add_argument('--featurized_data_path', default='', type=str, help='path to featurized dataset for speed up')
    ...
    if args.featurized_data_path:
        ...
        if args.save_processed_data:
            with open(f'processed_datasets/featurized_data_{args.algo}', "wb") as f:
                pickle.dump(mpnn_dataset, f)
            print(f"Saved featurized data to processed_datasets/featurized_data_{args.algo}")
